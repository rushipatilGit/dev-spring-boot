...
public class EmployeeController {
    ...
    @Autowired // is optional in case of only Constructor injection
    ...
    public String deleteEmployee(@RequestParam("employeeId") int theId, Model theModel){
        ...
        // delete the employee using service based on id
        employeeService.deleteById(theId);
        // Return to the list html page, i.e. redirect to the /employees/list
        return "redirect:/employees/list";
    }
}
